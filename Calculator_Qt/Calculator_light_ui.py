...
################################################################################
## Form generated from reading UI file 'Calculator_light.ui'
##
...
class Ui_CalculatorLightView(object):
    def setupUi(self, CalculatorLightView):
        if not CalculatorLightView.objectName():
            CalculatorLightView.setObjectName(u"CalculatorLightView")
        CalculatorLightView.resize(400, 700)
        CalculatorLightView.setMinimumSize(QSize(400, 700))
        CalculatorLightView.setMaximumSize(QSize(400, 700))
        icon = QIcon()
        icon.addFile(u":/Assets/empty.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        CalculatorLightView.setWindowIcon(icon)
        CalculatorLightView.setStyleSheet(u"QPushButton {\n"
...
"background-color: #505050;\n"
"}")
        self.verticalLayout = QVBoxLayout(CalculatorLightView)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.lbl_small = QLabel(CalculatorLightView)
        ...
        self.lbl_big = QLabel(CalculatorLightView)
        ...
        self.btn_1 = QPushButton(CalculatorLightView)
        ...
        self.btn_percent = QPushButton(CalculatorLightView)
        ...
        self.btn_4 = QPushButton(CalculatorLightView)
        ...
        self.btn_ac = QPushButton(CalculatorLightView)
        ...
        self.btn_change_sign = QPushButton(CalculatorLightView)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Assets/invert_dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.btn_7 = QPushButton(CalculatorLightView)
        ...
        self.btn_divide = QPushButton(CalculatorLightView)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Assets/divide_dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_divide.setIcon(icon2)
        self.btn_divide.setIconSize(QSize(20, 20))

        self.gridLayout.addWidget(self.btn_divide, 0, 3, 1, 1)

        self.btn_8 = QPushButton(CalculatorLightView)
        ...
        self.btn_9 = QPushButton(CalculatorLightView)
        ...
        self.btn_multiply = QPushButton(CalculatorLightView)
        ...
        self.btn_5 = QPushButton(CalculatorLightView)
        ...
        self.btn_6 = QPushButton(CalculatorLightView)
        ...
        self.btn_minus = QPushButton(CalculatorLightView)
        ...
        self.btn_2 = QPushButton(CalculatorLightView)
        ...
        self.btn_3 = QPushButton(CalculatorLightView)
        ...
        self.btn_plus = QPushButton(CalculatorLightView)
        ...
        self.btn_dot = QPushButton(CalculatorLightView)
        ...
        self.btn_equal = QPushButton(CalculatorLightView)
        ...
        self.btn_0 = QPushButton(CalculatorLightView)
        ...
        self.retranslateUi(CalculatorLightView)

        QMetaObject.connectSlotsByName(CalculatorLightView)
    # setupUi

    def retranslateUi(self, CalculatorLightView):
        CalculatorLightView.setWindowTitle("")
        self.lbl_small.setText(QCoreApplication.translate("CalculatorLightView", u"96 +", None))
        ...
        self.btn_ac.setText(QCoreApplication.translate("CalculatorLightView", u"AC", None))
        self.btn_change_sign.setText("")
        self.btn_7.setText(QCoreApplication.translate("CalculatorLightView", u"7", None))
        self.btn_divide.setText("")
        self.btn_8.setText(QCoreApplication.translate("CalculatorLightView", u"8", None))
        self.btn_9.setText(QCoreApplication.translate("CalculatorLightView", u"9", None))
        self.btn_multiply.setText(QCoreApplication.translate("CalculatorLightView", u"x", None))
        self.btn_5.setText(QCoreApplication.translate("CalculatorLightView", u"5", None))
        self.btn_6.setText(QCoreApplication.translate("CalculatorLightView", u"6", None))
        self.btn_minus.setText(QCoreApplication.translate("CalculatorLightView", u"-", None))
        self.btn_2.setText(QCoreApplication.translate("CalculatorLightView", u"2", None))
        self.btn_3.setText(QCoreApplication.translate("CalculatorLightView", u"3", None))
        self.btn_plus.setText(QCoreApplication.translate("CalculatorLightView", u"+", None))
        self.btn_dot.setText(QCoreApplication.translate("CalculatorLightView", u".", None))
        self.btn_equal.setText(QCoreApplication.translate("CalculatorLightView", u"=", None))
        self.btn_0.setText(QCoreApplication.translate("CalculatorLightView", u"0", None))
    # retranslateUi
