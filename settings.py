...
MATH_POSITIONS = {
    '/': {'col': 3, 'row': 2, 'character': '',
          'image path': {'light': 'images/divide_light.png', 'dark': 'images/divide_dark.png'}},
...
OPERATORS = {
    ...
    'invert': {'col': 1, 'row': 2, 'text': '',
               'image path': {'light': 'images/invert_light.png', 'dark': 'images/invert_dark.png'}},
